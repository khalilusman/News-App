...
export default class News extends Component {
  ...
  fetchArticles = async (page) => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=df033abef29c46a3a916e666817f5288&page=${page}&pageSize=${this.props.pageSize}`;
